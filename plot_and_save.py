...
def plot_figures(neg_lnL_all,F_all,D_all,F,D,bin_centers,beta_MC_schedule,beta_MC_steps,
                n_stages,n_attempts,gamma,coord_name,no_display,Propagator,Tij):
...
def save_datafiles(beta_MC_schedule,beta_MC_steps,Tij,Propagator,F,D,F_all,D_all,neg_lnL_all):
    logging.info("Saving:")
